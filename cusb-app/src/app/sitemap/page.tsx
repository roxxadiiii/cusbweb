...
const sitemap = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "CBCS Regulations", href: "/academics" },
      { label: "Academic Calendar", href: "/academic-calendar" },
      { label: "Examination", href: "/examination" },
      { label: "Digital Library", href: "https://ndl.iitkgp.ac.in" },
    ],
  },
  {
    section: "Admissions",
  ...
  },
  {
    ...
    href: "/administration",
    links: [
      { label: "Executive Council", href: "/administration" },
      { label: "Academic Council", href: "/administration" },
      { label: "Finance Committee", href: "/administration" },
      { label: "Planning Board", href: "/administration" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Research Centres", href: "/research" },
      { label: "Consultancy", href: "/research" },
      { label: "IPR Cell", href: "/research" },
    ],
  },
  {
    ...
    href: "/student-life",
    links: [
      { label: "Clubs & Associations", href: "/student-life" },
      { label: "Hostel & Mess", href: "/student-life" },
      { label: "Sports & Fitness", href: "/student-life" },
      { label: "Student Welfare", href: "/student-life" },
      { label: "Anti-Ragging Cell", href: "/student-life" },
      { label: "Alumni", href: "/student-life" },
    ],
  },
  {
    section: "Faculty",
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Academic Notices", href: "/news" },
    ],
  },
  {
    ...
    links: [
      ...
      { label: "SWAYAM Prabha", href: "https://swayamprabha.gov.in" },
